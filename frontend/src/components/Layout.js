...
const communityNavigation = [
  { name: 'Community Hub', href: '/community', icon: ChatBubbleLeftRightIcon },
  { name: 'Live Stats', href: '/stats', icon: ChartBarIcon },
...
const submissionNavigation = [
  { name: 'Submit Pattern', href: '/submit/pattern', icon: PlusIcon },
  { name: 'Submit Docs', href: '/submit/docs', icon: DocumentTextIcon },
  { name: 'Submit Integration', href: '/submit/integration', icon: CodeBracketIcon },
  { name: 'Report Bug', href: '/submit/bug', icon: ShieldExclamationIcon },
];

const helpNavigation = [
  { name: 'Help Center', href: '/help', icon: QuestionMarkCircleIcon },
  { name: 'API Docs', href: '/api', icon: CodeBracketIcon },
