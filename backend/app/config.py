...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get("DATABASE_URL", "postgresql://postgres:postgres@172.17.14.65:5432/versionintel")
    ...
    # CORS configuration - Allow all IPs in the 172.17.x.x network range for office access
    CORS_ORIGINS = [
    ...
    # For office network access, allow any IP in the 172.17.x.x range
