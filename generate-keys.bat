@echo off
REM Generate Secure Keys for VersionIntel Production

echo Generating secure keys for VersionIntel production deployment...
echo.

REM Generate SECRET_KEY (64 characters)
echo SECRET_KEY for .env file:
python -c "import secrets; print('SECRET_KEY=' + secrets.token_hex(32))"
echo.

REM Generate JWT_SECRET_KEY (64 characters)
echo JWT_SECRET_KEY for .env file:
python -c "import secrets; print('JWT_SECRET_KEY=' + secrets.token_hex(32))"
echo.

REM Generate secure database password
